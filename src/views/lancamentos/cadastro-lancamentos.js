            ...
            <Card title={this.state.atualizando ? 'Atualização de Lançamento': 'Cadastro de Lançamento'}>
                <div className="row">
                    <div className="col-md-12">
                        <FormGroup id="ïnputDescricao" label="Descrição: *">
                            <input id="ïnputDescricao" type="text"
                ...
                <div className="row">
                    <div className="col-md-6">
                        <FormGroup id="ïnputAno" label="Ano: *">
                            <input id="ïnputAno" type="text" 
                            className="form-control"
                            name="ano"
                    ...
                    <div className="col-md-6">
                        <FormGroup id="ïnputMes" label="Mes: *">
                            <SelectMenu id="ïnputMes" 
                                        className="form-control" 
                                        lista={meses}
                                        name="mes"
                ...
                <div className="row">
                    <div className="col-md-4">
                        <FormGroup id="ïnputValor" label="Valor: *">
                            <input id="ïnputValor" type="text" 
                            className="form-control"
                            name="valor"
                    ...
                    <div className="col-md-4">
                        <FormGroup id="ïnputTipo" label="Tipo: *">
                    ...
                    <div className="col-md-4">
                        <FormGroup id="ïnputStatus" label="Status: *">
                            <input id="ïnputStatus" type="text" 
                                    className="form-control" 
                                    disabled 
                                    name="status"
